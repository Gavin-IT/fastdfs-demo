...
class TrackerServerPool {
     ...
     * @throws FastdfsException 上传下载相关异常
     */
    static TrackerServer borrowObject() throws FastdfsException {
     ...
     */
    static void returnObject(TrackerServer trackerServer){
