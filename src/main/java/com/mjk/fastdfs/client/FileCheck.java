...
public class FileCheck {
     ...
     * @return boolean
     */
    private static boolean checkImage(List<String> types, String filename){
     ...
     * @return boolean
     */
    private static boolean checkDoc(List<String> types, String filename){
        List<String> checkTypes = types;
        if(types == null || types.size() == 0){
            checkTypes = TYPE_DOC;
        }
     ...
     * @return boolean
     */
    private static boolean checkVideo(List<String> types, String filename){
        List<String> checkTypes = types;
        if(types == null || types.size() == 0){
     ...
     * @return
     */
    private static boolean checkCompress(List<String> types, String filename){
        List<String> checkTypes = types;
        if(types == null || types.size() == 0){
